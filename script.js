...
// defining some songs here with properties as follows
const allSongs = [
    {
        id: 0,
...
// this object will allow us to directly use the browser Audio API
...
// to convert the songs object into an HTML array of list items
...
// function to be called to play a specific song with specific Id
/**
 *
 * @param {Number} id
 * @returns {void}
 */
const playSong = (id) => {
    // first need to get the song object
    const song = userData?.songs.find((song) => song.id === id);
    audio.src = song.src;
    audio.title = song.title;

    // if this song is different than currently playing song, then
    // i need to reset the currentTime
    if (
    ...
    // otherwise update the user data and add a class to the play button
...
// adding an event listener to the play button
